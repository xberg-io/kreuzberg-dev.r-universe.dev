...
R-universe package registry for the [Kreuzberg](https://github.com/xberg-io) organization.

## Packages

| Package | Source Repository | Description |
|---------|-------------------|-------------|
| [kreuzberg](https://xberg-io.r-universe.dev/kreuzberg) | [xberg-io/kreuzberg](https://github.com/xberg-io/kreuzberg) | Extract text and metadata from 90+ file formats |
...
```r
# Install kreuzberg
install.packages("kreuzberg", repos = "https://xberg-io.r-universe.dev")
